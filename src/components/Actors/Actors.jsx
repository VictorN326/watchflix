...
import { useGetActorsInfoQuery, useGetActorsMoviesQuery } from '../../services/TMDB';
...
const Actors = () => {
  ...
  const {data: movies} = useGetActorsMoviesQuery({id, page})
  if(isFetching) {
    return(
    ...
    <>
      ...
      <Box margin='2rem 0'>
        <Typography variant='h2' gutterBottom align="center">Movies</Typography>
         {/* shows the movies that other actors/actress are in below actor page */}
        {movies && <MovieList movies={movies} numberOfMovies={12}/>}
        {/* previous and next component to check other actors and actresses movies */}
